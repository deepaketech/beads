...
$(function() {
		...
		//jQuery.widget("Navigationmenupro.menugrid", $.extend({}, $.ui.sortable.prototype, {		
			  _create: function() {
		...
		_form_validation:function(){
			...
			_store_filter: function(){
				console.log('_store_filter start');
			...
			console.log('_footersticky start');	
				var winHeight = jQuery(window).height(); 
