...
(function( factory ) {
	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
		...
		options: {
			...
			/*Add this Class & Code TO Stop Drag & Drop the Group Li Which have Class custom-drag-drop-stop*/
			disableDragDropClass: 'custom-drag-drop-stop'
		...
		_isAllowed: function(parentItem, level, levels) {
			...
			if ((this.currentItem[0].className.indexOf(o.disableDragDropClass) !== -1) || ! o.isAllowed(this.placeholder, parentItem, this.currentItem))
			{
			...
			/* Here We set the Menu To Do not make it as Parent It is complusary to put the menu iten in the Li of the Group*/
			//console.log("maxLevels "+maxLevels);
			//console.log("levels "+levels);
			//console.log("Parent To Parent Node Class:: "+$(this.currentItem[0].parentNode.parentNode).attr('class'));
			//serialized = $('ol.sortable').nestedSortable('serialize');
			//console.log("menuitemorderList ::111 "+menuitemorderList);
			//console.log( $("#navmenu ol li").get(0));
			//console.log("Frist Li :: "+$('#navmenu ol li:first').attr('id'));
			//console.log("Current:: "+$(this.currentItem[0]).attr('id'));
			//console.log("Next Node :: "+$(this.currentItem[0]).next().attr('id'));
			//console.log("Previous To Previous Node :: "+$(this.currentItem[0]).prev().attr('id'));
			//console.log("Current Item id:: "+$(this.currentItem[0]).attr('id'));
				//console.log("Parent Node :: "+this.currentItem[0].parentNode[0]);
				//console.log("Next Node :: "+$(this.currentItem[0]).next().attr('id'));
				
				
				//console.log("Parent Attribute Class"+$(this.currentItem[0].parentNode).attr('id'));
				//console.log(this.currentItem[0].parentNode);	
			//console.log(this.currentItem[0].parentNode);
			if(levels == "1"){
				//alert("dsad");
				//console.log(currentItem[0].parentItem[0].id);
				/*this.placeholder.addClass(o.errorClass);
					if (maxLevels < levels && maxLevels != 0) {
						this.beyondMaxLevels = levels - maxLevels;
					} else {
