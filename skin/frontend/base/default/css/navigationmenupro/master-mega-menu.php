...
///* Menu Outer */
#cwsMenu-@{group_id}.cwsMenuOuter { background-color:@menubgcolor; max-width:1140px; margin:auto; padding:@menupadding; }
...
#cwsMenu-@{group_id} {
	...
	@media @desktop {
		...
		.cwsMenu li.Level1 > a:hover { color:@mmlvl1colorh; background-color:@mmlvl1bgcolorh; }
		...
		.cwsMenu.mega-menu > li.column-1.aRight:not(.megamenu) li.parent>a>span.arw when (@lvl0arw = 1) { border-left-color:transparent; border-right-color:@ddlinkcolor; }
		.cwsMenu.mega-menu > li.column-1.aRight:not(.megamenu) li.parent:hover>a>span.arw when (@lvl0arw = 1) { border-left-color:transparent; border-right-color:@ddlinkcolorh; }
		.cwsMenu.mega-menu > li.column-1.aRight:not(.megamenu) li.parent.active>a>span.arw when (@lvl0arw = 1) { border-left-color:transparent; border-right-color:@ddlinkcolora; }
		...
		.cwsMenu.vertical > li.parent.aRight a>span.arw { border-left-color:transparent; border-right-color:@ddlinkcolor; }
	...
	@media @mobile {
		...
		&.cwsMenuOuter { background-color:@mopnl-bgcolor; padding:@mopnl-padding; border:1px solid @mopnl-bordercolor; border-width:@mopnl-borderwidth; border-radius:@mopnl-lvl0corner; }
		.cwsMenu.mega-menu {
			li a > span.arw { color:@mopnl-lvl0color; display:block; }
		}
		
		///***** Root Menu Items styles ****/
		.cwsMenu li {
			border-top:1px solid @mopnl-lvl0dvcolor;
			a { color:@mopnl-lvl0color; font-weight:@mopnl-lvl0weight; font-size:@mopnl-lvl0size; padding:@mopnl-lvl0padding; text-transform:@mopnl-lvl0case; background-color:@mopnl-lvl0bgcolor; }
			a:hover,
			&.active > a { color:@mopnl-lvl0colora; background-color:@mopnl-lvl0bgcolora; outline:0 none; }
			
			& when (@mopnl-sublvlcolor = darken) {
				a span.arw { background-color:darken(@mopnl-lvl0bgcolor, 5%); }
				li {
					border-top-color:darken(@mopnl-lvl0dvcolor, 6%);
					a { font-weight:400; font-size:@mopnl-lvl0size; background-color:darken(@mopnl-lvl0bgcolor, 6%);
						&:before { content:" "; float:left; width:6px; height:(@mopnl-lvl0size + 5px); }
						span.arw { background-color:darken(@mopnl-lvl0bgcolor, 10%); }
					}
					li {
						border-top-color:darken(@mopnl-lvl0dvcolor, 12%);
						a { font-size:(@mopnl-lvl0size - 1px); background-color:darken(@mopnl-lvl0bgcolor, 12%);
							&:before { width:12px; }
							span.arw { background-color:darken(@mopnl-lvl0bgcolor, 15%); }
						}
						li {
							border-top-color:darken(@mopnl-lvl0dvcolor, 16%);
							a { font-size:(@mopnl-lvl0size - 2px); background-color:darken(@mopnl-lvl0bgcolor, 16%);
								&:before { width:18px; }
								span.arw { background-color:darken(@mopnl-lvl0bgcolor, 20%); }
							}
							li {
								border-top-color:darken(@mopnl-lvl0dvcolor, 20%);
								a { background-color:darken(@mopnl-lvl0bgcolor, 20%);
									&:before { width:24px; }
									span.arw { background-color:darken(@mopnl-lvl0bgcolor, 24%); }
								}
							}
						}
					}
			...
			& when (@mopnl-sublvlcolor = lighten) { 
				a span.arw { background-color:lighten(@mopnl-lvl0bgcolor, 5%); }
				li {
					border-top-color:lighten(@mopnl-lvl0dvcolor, 6%);
					a { font-weight:400; font-size:@mopnl-lvl0size; background-color:lighten(@mopnl-lvl0bgcolor, 6%);
						&:before { content:" "; float:left; width:6px; height:(@mopnl-lvl0size + 5px); }
						span.arw { background-color:lighten(@mopnl-lvl0bgcolor, 10%); }
					}
					li {
						border-top-color:lighten(@mopnl-lvl0dvcolor, 12%);
						a { font-size:(@mopnl-lvl0size - 1px); background-color:lighten(@mopnl-lvl0bgcolor, 12%);
							&:before { width:12px; }
							span.arw { background-color:lighten(@mopnl-lvl0bgcolor, 16%); }
						}
						li {
							border-top-color:lighten(@mopnl-lvl0dvcolor, 18%);
							a { font-size:(@mopnl-lvl0size - 2px); background-color:lighten(@mopnl-lvl0bgcolor, 18%);
								&:before { width:18px; }
								span.arw { background-color:lighten(@mopnl-lvl0bgcolor, 24%); }
							}
							li {
								border-top-color:lighten(@mopnl-lvl0dvcolor, 22%);
								a { background-color:lighten(@mopnl-lvl0bgcolor, 22%);
									&:before { width:24px; }
									span.arw { background-color:lighten(@mopnl-lvl0bgcolor, 26%); }
								}
							}
						}
					}
