...
jQuery(function() {
			...
			_create: function() {
				...
				//jQuery(".mega-menu.horizontal > li > ul.Level0").css("display",toplinkdisplay);
				
				/*
				var sublinkHeight = jQuery(".mega-menu.horizontal > li > ul.subMenu").height();
				console.log("sublinkHeight::"+sublinkHeight);*/
			...
			_toggleHeight(e){
				...
				jQuery(this).stop().animate({"height":h},200);
			},
