 ...
 ***************************************************************************/
class CapacityWebSolutions_NavigationMenuPro_Model_Status extends Varien_Object
{
    ...
    {
        return array(
            self::STATUS_ENABLED    => Mage::helper('navigationmenupro')->__('Enabled'),
            self::STATUS_DISABLED   => Mage::helper('navigationmenupro')->__('Disabled')
        );
    }
}