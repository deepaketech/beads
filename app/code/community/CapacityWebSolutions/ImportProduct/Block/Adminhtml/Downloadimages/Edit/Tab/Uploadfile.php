...
class CapacityWebSolutions_ImportProduct_Block_Adminhtml_Downloadimages_Edit_Tab_Uploadfile extends Mage_Adminhtml_Block_Widget_Form
{
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('importproduct/imageupload.phtml');
    }
