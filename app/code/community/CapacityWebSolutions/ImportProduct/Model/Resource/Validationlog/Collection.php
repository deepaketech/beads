...
class CapacityWebSolutions_ImportProduct_Model_Resource_Validationlog_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    protected function _construct()
    {
        $this->_init('importproduct/validationlog');
    }
} 