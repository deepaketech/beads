...
class Mirasvit_SearchIndex_Model_Index_Smartwave_Blog_Post_Index extends Mirasvit_SearchIndex_Model_Index
{
    ...
    {
        return Mage::getConfig()->getModuleConfig('Smartwave_Blog')->is('active', 'true');
    }
