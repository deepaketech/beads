...
class Amasty_Stockstatus_Model_Observer
{
    ...
    public function coreBlockAbstractToHtmlBefore($observer)
    {
        ...
        if (Mage::getStoreConfig('amstockstatus/general/displayinemail')) {
            ...
            /* recomment where there is problem with bundle template
            if (($observer->getBlock() instanceof Mage_Bundle_Block_Sales_Order_Items_Renderer)) {
                if ($observer->getBlock()->getTemplate() == "bundle/email/order/items/order/default.phtml") {
                    $observer->getBlock()->setTemplate('amasty/amstockstatus/bundle/email/order/items/order/default.phtml');
                }
            }*/
        }
    }
