		...
		if($params['isAjax'] == 1){
			...
			try {
				...
				if (!$cart->getQuote()->getHasError()){
					...
					$message = '<div class="msg">'.$params['qty'] .$this->__("  Added to cart!").'<p class="product-name theme-color"></p><div class="timer theme-color">'.$autoclose.'</div></div>'.$product_image;
			...
			Mage::register('referrer_url', $this->_getRefererUrl());
                    $cart_button = '<div class="incart">';
                    $cart_button .='<a id="incart_'.$product->getId().'" href="javascript:void(0)" class="addtocart" title="Add to Cart"><i class="icon-cart"></i><span>&nbsp; In cart</span></a>';
                    $cart_button .='</div>';

                    $response['toplink'] = $toplink;
                    $response['cart_sidebar'] = $cart_sidebar;
                    $response['cart_button'] = $cart_button;
...
$toplink = "";
                    ...
                    $cart_button = '<div class="incart">';
                    $cart_button .='<a href="" class="addtocart" title="Add to Cart"><i class="icon-cart"></i><span>&nbsp; In cart</span></a>';
                    $cart_button .='</div>';
