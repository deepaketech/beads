...
class Mirasvit_SearchIndex_Model_Index_Aw_Blog_Post_Index extends Mirasvit_SearchIndex_Model_Index
{
    ...
    {
        return Mage::getConfig()->getModuleConfig('AW_Blog')->is('active', 'true');
    }
